...
import { Menu, Home, Calendar, Package, Users, BarChart3, LogOut, X } from 'lucide-react';
...
const Navbar = () => {
  ...
  const getNavItems = () => {
    if (user?.role === 'Admin') {
      ...
      return [{ icon: <Calendar className="transition-transform group-hover:scale-110" size={20} />, text: 'My Bookings', path: '/bookings' }];
    }
  };
